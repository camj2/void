...
[Update](https://www.gigabyte.com/Motherboard/X570S-AORUS-ELITE-AX-rev-1x/support#support-dl-bios)
...
desktop-file-edit \
  --set-key=Exec \
  --set-value="/usr/lib/code-oss/bin/code-oss --enable-features=UseOzonePlatform --ozone-platform=wayland %F" \
...
```
touch ~/.local/share/applications/libreoffice-startcenter.desktop
touch ~/.local/share/applications/signal-desktop.desktop
```

#### Font

```
xbps-restricted msttcorefonts
```
