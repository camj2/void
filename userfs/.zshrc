...
alias restart-router="ssh root@10.0.0.1 reboot"
alias restart-server="ssh server doas reboot"
alias restart-backup="ssh backup doas reboot"
alias restart-all="ssh backup doas reboot; ssh server doas reboot; ssh root@10.0.0.1 reboot"
alias restart="ssh backup doas reboot; ssh server doas reboot"

alias router="ssh root@10.0.0.1"
alias network="ssh server"
alias server="ssh server"
alias backup="ssh backup"

# alias computer="ssh computer"
# alias laptop="ssh laptop"
# alias phone="ping phone"

alias code-oss="code-oss --enable-features=UseOzonePlatform --ozone-platform=wayland &> /dev/null"
alias c="code-oss --enable-features=UseOzonePlatform --ozone-platform=wayland &> /dev/null"
